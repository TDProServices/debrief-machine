...
**Purpose**: Convert documentation templates into conversation-driven processes using The Debrief Machine system

---

## 📚 **What These Prompts Actually Are**

**Conversation-to-Documentation Converters**: These prompts turn natural conversations about completed work into professional documentation automatically.

**Real example**: Instead of manually filling out a 26-page project debrief form, you just talk naturally about your completed project. The AI asks the right follow-up questions and automatically organizes everything into professional documentation.

**Why you need it**: Eliminates the burden of remembering what to document, how to organize it, and how to write it professionally. Turns "filling out forms" into "having helpful conversations" that produce the same high-quality results.

---

## 🎯 **What Each Document Type Actually Is**

### **Technical Project Documentation**
**What it is**: Complete record of how a technical project went from start to finish

**Real example**: After building a mobile app, documentation covers "What worked well? What was harder than expected? What would we do differently? How much did it cost vs. budget?" - becomes a reference guide for future projects
...
**Real example**: For a new website, it specifies "Users need to log in, see order history, make new orders, get email confirmations" - prevents building the wrong thing
...
**Real example**: After implementing new expense approval process, check "Are people following it? Is it faster? Are there problems?" - finds if changes actually improved things
...
**Real example**: Switching from Excel to project management tool - covers "How long did setup take? What broke? Are people using it? What training is needed?"
...
**Real example**: After safety training, check "Do they remember procedures? Are they following them? Are accidents decreasing?" - tells if training was worth the time and money
...
```
Template: "Fill out the risk assessment section..."
You: "Uh, what risks? Let me think..."
```

**You get this (new way)**:
```
AI: "Tell me about your project completion"
You: "We finished the website last week"
AI: "What challenges did you face? How did stakeholders react?"
You: [natural conversation about the project]
AI: [Creates complete professional documentation automatically]
```

**The Magic**: Instead of filling out forms, you have helpful conversations that produce professional results.
