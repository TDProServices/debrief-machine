...
**Research Limitations**: AI-generated source analysis and fact-checking should supplement, not replace, human expert evaluation. Source credibility assessments are algorithmic and may not capture all nuances of authority and bias.

**Information Currency**: While this system prioritizes recent sources, information changes rapidly. Users should verify currency of critical facts independently, especially for time-sensitive decisions.

**Geographic and Cultural Bias**: Source selection and authority scoring may reflect Western/English-language bias. Users should seek diverse geographic and cultural perspectives for global topics.

**Professional Research Standards**: For academic, legal, or professional research, this system should supplement formal research methodologies, not replace peer review or expert validation processes.
...
### **Source Strategy**:
- **Primary sources first**: Official documents, data, direct statements
- **Expert verification**: Industry authorities and academic experts
- **Multiple perspectives**: Avoid single-source bias
- **Recent validation**: Prioritize current and updated information
- **Geographic relevance**: Consider regional variations in data

### **Research Continuation Best Practices**:
1. **Document methodology gaps** for future investigation
2. **Identify high-value research questions** for next session
3. **Note source limitations** and verification needs
4. **Plan strategic verification approaches** for complex claims
5. **Prepare research handoff** with specific source requirements