...
**Sensitivity Levels:**
- **Hair Trigger** (5+ points): Generate briefing on any meaningful progress
- **Balanced** (8+ points): Standard threshold for most projects  
- **Conservative** (15+ points): Only on explicit completion signals

**Default Mode**: Balanced with autonomous research enabled